...
public class StartClient {
    public static void main(String[] args) {
        ExampleClient client = new ExampleClient("localhost", 11113);
        ...
        final AtomicInteger onNextsReceived = new AtomicInteger();
        ...
        for (int i = 0; i < NUM_CONCURRENT_CALLS; i++) {
            responses.add(
                    Observable.defer(() -> {
                        ...
                        return hystrixService.invoke(null)
                                .doOnNext(s -> onNextsReceived.getAndIncrement())
        ...
        Subscription subscription = Observable.merge(responses).subscribe(new Subscriber<String>() {
            @Override
        ...
        try {
            ...
            System.out.println("OnNexts received : " + onNextsReceived);
